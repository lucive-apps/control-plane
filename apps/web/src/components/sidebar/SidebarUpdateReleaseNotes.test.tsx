...
describe("SidebarUpdateReleaseNotes", () => {
  ...
  it("links each preview to its exact release and labels hidden changes", () => {
    ...
    expect(anchors.map(({ props }) => props.href)).toEqual([
      "https://github.com/lucive-apps/control-plane/releases/tag/v0.0.36-nightly.3",
      "https://github.com/lucive-apps/control-plane/releases/tag/v0.0.36-nightly.2",
      "https://github.com/lucive-apps/control-plane/releases/tag/v0.0.36-nightly.1",
    ]);
