 ...
 * machine into a Control Plane browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Control Plane profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Control Plane Full Disk Access in System Settings → Privacy & Security, then retry.",
